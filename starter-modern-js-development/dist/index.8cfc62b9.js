...
(0, _shoppingCartJsDefault.default)("gluten-free pizza", 2);
(0, _shoppingCartJsDefault.default)("gluten-free bread", 1);
(0, _shoppingCartJsDefault.default)("vegan cheese", 5);
...
const ShoppingCart2 = function() {
    ...
    const addToCart = function(product, quantity) {
        ...
        console.log(`${quantity} ${product}${quantity >= 2 ? "s" : ""} added to cart. Shipping costs: ${shoppingCost}`);
    };
    const orderStock = function(product, quantity) {
        ...
        console.log(`${quantity} ${product}${quantity >= 2 ? "s" : ""} ordered from supplier`);
    };
...
parcelHelpers.export(exports, "default", ()=>function(product, quantity) {
        ...
        console.log(`${quantity} ${product}${quantity >= 2 ? "s" : ""} added to cart`);
    });
...
},{"./_getTag.js":"1kCom","./isObjectLike.js":"iad76","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hIFAM","6rimH"], "6rimH", "parcelRequire04a8")
